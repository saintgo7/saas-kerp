...
const mockPurchaseOrders: PurchaseOrder[] = [
  {
    ...
    items: [
      { id: "1", purchaseOrderId: "1", productId: "1", product: mockProducts[0], quantity: 10, unitPrice: 1200000, amount: 12000000, taxAmount: 1200000, receivedQuantity: 10, note: "" },
      { id: "2", purchaseOrderId: "1", productId: "2", product: mockProducts[1], quantity: 50, unitPrice: 28000, amount: 1400000, taxAmount: 140000, receivedQuantity: 50, note: "" },
    ],
  ...
  },
  {
    ...
    warehouse: mockWarehouses[0],
    items: [
      { id: "3", purchaseOrderId: "2", productId: "3", product: mockProducts[2], quantity: 100, unitPrice: 22000, amount: 2200000, taxAmount: 220000, receivedQuantity: 60, note: "" },
    ],
    totalAmount: 2200000,
    taxAmount: 220000,
    grandTotal: 2420000,
  ...
  },
  {
    ...
    items: [
      { id: "4", purchaseOrderId: "3", productId: "5", product: mockProducts[4], quantity: 20, unitPrice: 62000, amount: 1240000, taxAmount: 124000, receivedQuantity: 0, note: "" },
    ],
    totalAmount: 1240000,
    taxAmount: 124000,
    grandTotal: 1364000,
  ...
  },
  {
    ...
    warehouse: mockWarehouses[0],
    items: [
      { id: "5", purchaseOrderId: "4", productId: "4", product: mockProducts[3], quantity: 500, unitPrice: 800, amount: 400000, taxAmount: 40000, receivedQuantity: 0, note: "" },
    ],
    totalAmount: 400000,
    taxAmount: 40000,
    grandTotal: 440000,
...
// Status styles
const statusStyles: Record<PurchaseOrderStatus, { variant: "default" | "secondary" | "destructive" | "success" | "warning"; icon: React.ReactNode }> = {
  draft: { variant: "secondary", icon: <Edit className="h-3 w-3" /> },
  pending: { variant: "warning", icon: <ShoppingCart className="h-3 w-3" /> },
  approved: { variant: "default", icon: <CheckCircle className="h-3 w-3" /> },
  ordered: { variant: "default", icon: <Truck className="h-3 w-3" /> },
...
const getStatusLabel = (status: PurchaseOrderStatus) => {
  const found = PURCHASE_ORDER_STATUS.find((s) => s.value === status);
  return found ? found.label : status;
};

// Validation schema for new purchase order
const purchaseOrderSchema = z.object({
  supplierId: z.string().min(1, "거래처를 선택하세요"),
 ...
 * Manages purchase orders with list and form views
 */
export function PurchaseOrderPage() {
  ...
  // Calculate summary
  const pendingCount = mockPurchaseOrders.filter((o) => o.status === "pending" || o.status === "ordered").length;
  const totalAmount = mockPurchaseOrders.reduce((sum, o) => sum + o.grandTotal, 0);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">구매 관리</h1>
          <p className="text-muted-foreground">발주서를 작성하고 입고를 처리합니다.</p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{mockPurchaseOrders.length}건</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{pendingCount}건</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">발주 총액</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">발주서 목록</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
          ...
          {filteredOrders.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium mb-2">발주서가 없습니다</h3>
              <p className="text-muted-foreground mb-4">새로운 발주서를 작성해보세요.</p>
              <Button onClick={() => setShowFormModal(true)}>
                <Plus className="h-4 w-4 mr-2" />
                발주서 작성
              </Button>
          ...
          <div className="space-y-4">
            <div className="bg-muted/50 rounded-lg p-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <span className="text-muted-foreground">입고예정일:</span>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">기입고</TableHead>
                  <TableHead className="text-right">미입고</TableHead>
                ...
                {selectedOrder.items.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="text-right font-mono text-orange-600">
                      {(item.quantity - item.receivedQuantity).toLocaleString()}
                    </TableCell>
